...
p = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/spiralNorth_50km.txt')
p2 = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/spiralNorth_A50.txt')
p3 = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/spiralNorth_A250.txt')
...
for result in range(0, p3.no_sims):
    ax1.plot(p3.variables[result][0] ** 2 / (25000*10**6), p3.outcome[result], 'xC2')
...
three = mlines.Line2D([], [], color='C2', marker='x', markersize=5, label='Area = 25000km$^2$')
