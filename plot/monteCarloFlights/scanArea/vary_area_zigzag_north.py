...
p = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/zigzag_north_A2500.txt')
p2 = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/zigzag_north_A5000.txt')
p3 = ProcessSensitivity(file_path='../../../data/monte_carlo_results/scanArea/zigzag_north_A7500.txt')
...
ax1.set_title('Up and Down North')
