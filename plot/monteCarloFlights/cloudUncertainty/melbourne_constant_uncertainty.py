...
p = ProcessSensitivity('../../../data/monte_carlo_results/cloudUncertainty/melbourne_constant_0p10.txt')
p2 = ProcessSensitivity('../../../data/monte_carlo_results/cloudUncertainty/melbourne_constant_0p05.txt')
p3 = ProcessSensitivity('../../../data/monte_carlo_results/cloudUncertainty/melbourne_current_50.txt')
