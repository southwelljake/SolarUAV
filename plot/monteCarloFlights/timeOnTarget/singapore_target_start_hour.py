...
p = ProcessSensitivity('../../../data/monte_carlo_results/timeOnTarget/singapore_target_start_hour_100.txt')
...
for result in range(0, p.no_sims):
    ax1.plot(float(p.variables[result][0]), float(p.outcome[result]), 'xb')
