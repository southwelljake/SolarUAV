...
p = ProcessSensitivity(file_path='../../data/monte_carlo_results/scanArea/zigzag_north_500.txt')

# Plot results
fig1, ax1 = plt.subplots()

for result in range(0, p.no_sims):
    ax1.plot(p.variables[result][0] / p.variables[result][1], p.outcome[result], 'xb')
