...
for area in area:
    ...
    file_name = '../../../data/monte_carlo_results/scanArea/start_spiral_north_A' + str(area) + '.txt'
    no_sims = 100

    other_variables = [['flight_model.yaw.path.start_point[1]', [5000, 100000], 'int']]
